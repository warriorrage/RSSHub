...
// 四川日报
router.get('/scrb/gdxw', require('./routes/scrb/gdxw'));
router.get('/scrb/gcdt', require('./routes/scrb/gcdt'));

// 成都新闻
router.get('/cdxw/bd', require('./routes/cdxw/bd'));

// 英语学习
// 英语库
router.get('/yyxx/yyk', require('./routes/yyxx/yyk'));
// BBC学英语
router.get('/yyxx/bbc', require('./routes/yyxx/bbc'));
// ETtoday
router.get('/yyxx/et', require('./routes/yyxx/et'));
// 巨匠英语
router.get('/yyxx/jj', require('./routes/yyxx/jj'));
